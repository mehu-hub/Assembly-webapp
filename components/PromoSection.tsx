      ...
      <div className="relative z-10 px-8 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-14">
          {[
            ...
            <div key={cat.label} className={`group relative ${cat.glow} border border-white/5 rounded-2xl p-5 flex flex-col items-center gap-3 hover:border-white/20 hover:scale-105 transition-all duration-300 cursor-pointer overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={stat.label} className={`bg-white/5 border ${stat.border} rounded-2xl p-5 hover:bg-white/8 transition-colors duration-200`}>
